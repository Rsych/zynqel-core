...
func (s *Server) routes(webFS fs.FS) {
	...
	s.router.HandleFunc("GET /session-history", s.handleListSessionHistory)
	s.router.HandleFunc("GET /session-history/{id}", s.handleGetSessionHistory)
	s.router.HandleFunc("GET /session-history/{id}/log", s.handleGetSessionLog)
	s.router.HandleFunc("DELETE /session-history/{id}", s.handleDeleteSessionHistory)
